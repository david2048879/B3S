			...
			<div className="row ">
				<div className="col-md-2">
					<button
						...
						onClick={() => router.push("/ceo/staff_active/")}
					>
						Active Employees
					</button>
					<button
						className="btn btn-info btn-block"
						onClick={() => router.push("/ceo/staff_by_division/")}
					>
						Employees by Division
					</button>
					<button
						className="btn btn-info btn-block"
						onClick={() => router.push("/ceo/staff_by_department/")}
					>
						Employees by Department
					</button>
					{/* <button
						className="btn btn-info btn-block"
						onClick={() => router.push("/ceo/staff_to_bnr/")}
					>
						Employees list for BNR
					</button> */}
				</div>
				...
				<div className="row ">
					...
					>
						<input
							...
							placeholder='Type here part of employee name or job title or branch name or employee code or employee email, then press "Enter" to search.'
							style={{ width: "100%" }}
							title='Type here part of employee name or job title or branch name or employee code or employee email, then press "Enter" to search.'
						/>
					</form>
				</div>
				{addReportForm()}
...
export default withCEO(ceoHome);
