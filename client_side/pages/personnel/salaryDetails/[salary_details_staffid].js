...
const Salary = ({ token }) => {
	...
	const { salary_details_staffid } = router.query;
	...
	const getStaff = async () => {
		const response = await axios.get(
			`${API}/profile/${salary_details_staffid}`,
			{
				headers: {
	...
	return (
		<Layout>
				...
				<div className="row alert alert-primary text-center">
					...
					<div className="col-md-12 mt-1">
						...
						<span
							...
							onClick={() =>
								router.push("/personnel/monthlySalary")
							}
						...
						<div className="row">
							...
							{currentStaff &&
								...
								currentStaff.currentMonthSalary
									...
									<div className="col-md-12">
										Responsibility Allowance:&emsp;&emsp;
										{formatNumber(
											currentStaff.currentMonthSalary
							...
							{currentStaff &&
								...
								currentStaff.currentMonthSalary.cieCSR > 0 && (
									<div className="col-md-12">
										C.S.R Employer Contributions:&emsp;
										{formatNumber(
											currentStaff.currentMonthSalary
												.cieCSR
										)}
			...
			{/* {JSON.stringify(currentStaff.currentMonthSalary)} */}
		</Layout>
	);
};
export default withHR(Salary);
