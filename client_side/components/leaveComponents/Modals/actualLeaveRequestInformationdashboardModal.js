...
const ActualLeaveRequestDetails = ({ modalIsOpen, toggleModal, data }) => {
    return (
                    ...
                    <table className="table">
                        ...
                        <div className="mx-3">
                            <tbody style={{ lineHeight: 0.8 }}>
                                ...
                                <tr>
                                    <td>requested supervisor on:</td>
                                    <td></td>
                                    <td style={{ fontWeight: "bold" }}>{formatDateToCustomFormat(data.supervisorrequestdate)}</td>
                                </tr>
                                <tr>
                                ...
                                {data.hrrequesteddate&&<tr>
                                    <td>requested HR Manager on:</td>
                                    <td></td>
                                    <td style={{ fontWeight: "bold" }}>{formatDateToCustomFormat(data.hrmanagerrequest)}</td>
                                </tr>}
                            </tbody>
                        </div>
                    </table>
...
export default ActualLeaveRequestDetails;