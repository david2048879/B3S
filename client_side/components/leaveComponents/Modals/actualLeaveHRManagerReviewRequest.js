...
const HRManagerReviewRequest = ({ modalIsOpen, toggleModal, data, setData, handleReview }) => {
    ...
    return (
        <Modal isOpen={modalIsOpen} toggle={() => toggleModal()} className="d-flex align-items-center justify-content-center" size='md'>
            <div>
                ...
                <div className="row">
                    <div className="col">
                        {(showComment ||showApprove) && <div className="m-4">
...
export default HRManagerReviewRequest;